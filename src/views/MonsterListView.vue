<template>
  <div class="max-w-7xl mx-auto p-6">
    ...
    <template v-else>
      <!-- Filters Section -->
      <div
        class="bg-white/80 rounded-lg border-2 border-brown-900 p-6 shadow-lg mb-8 transition-all duration-300 hover:shadow-xl"
      >
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div class="col-span-1 md:col-span-2">
            ...
            <div class="relative">
              ...
              />
              <svg
                class="absolute left-3 top-2.5 h-5 w-5 text-brown-900"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
          ...
          <div>
            ...
            >
              ...
              <option v-for="cr in challengeRatings" :key="cr" :value="cr">CR {{ cr }}</option>
            </select>
          </div>
        </div>
      ...
      <div class="mb-4 flex justify-between items-center">
        <p class="font-medieval text-brown-900">Found {{ filteredMonsters.length }} monsters</p>
        <button
      ...
      <!-- No Results Message -->
      <div v-if="filteredMonsters.length === 0" class="text-center py-8">
